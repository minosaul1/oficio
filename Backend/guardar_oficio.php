...
$paciente_nombre    = $_POST['paciente_nombre']    ?? '';// Nuevo campo
...
$result = $conexion->query("SELECT oficio_no FROM oficios ORDER BY id DESC LIMIT 1");
...
// Preparar consulta
$stmt = $conexion->prepare("INSERT INTO oficios (
